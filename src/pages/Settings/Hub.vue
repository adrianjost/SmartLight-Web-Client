<template>
	<div class="hub">
		...
		<p>As long as you have any page of this app open, the website acts as an hub for external communication.</p>
		<p>So you can control your lights from anywhere on earth, as long as one device in your local network has this app opened.</p>
		<p>
			This is also required to be able to use Google Assistant & IFTTT. <a
		...
		<p class="token">
			<span
				v-for="(token, index) in api_token"
				:key="index"
			>
				{{ token }}
			</span>
